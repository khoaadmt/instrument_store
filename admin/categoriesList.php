...
<body>
                ...
                <?php foreach ($list as $key => $value) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="delete_category.php?id=<?= $value['id'] ?>" onclick="isCheckDelete(event)">Xóa</a>
                            <?php
                            if ($value['status']) { ?>
    ...
    <footer>
        <p class="copyright">MELODY MART @ 2023</p>
    </footer>
    <script>
        function isCheckDelete(event){
        let text_noty="Bạn có chắc chắn muốn xóa?";
        if(confirm(text_noty)==true){
