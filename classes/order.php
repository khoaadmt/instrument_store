...
class order
{
    ...
    public function add()
    {
        ...
        $recieveAddress = $_POST['recieveAddress'];
        $recieveName = $_POST['recieveName'];
        $SDT = $_POST['SDT'];
        ...
        //Add new order
        $sql_insert_cart = "INSERT INTO orders VALUES(NULL,'$userId','" . date('y/m/d') . "',NULL,'Processing', '$recieveAddress', '$SDT', '$recieveName'," . $totalPrice['total'] . ")";
        ...
        foreach ($cart_user as $key => $value) {
            ...
            $sql_insert_order_details = "INSERT INTO order_details VALUES(NULL,'$orderId'," . $value['productId'] . "," . $value['qty'] . ")";
